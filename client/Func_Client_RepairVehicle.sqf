	...
	for [{_i=0},{(_i<=20) && (getDammage _veh>0.04) && (alive _veh) && (_veh==Local_PlayerVehicle) && (abs(speed _veh) < 5) && (alive player)},{_i=_i+1}] do
	{	
		_dam=((getDammage _veh)-0.05) max 0;
