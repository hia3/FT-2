...
class RscGear
{
    ...
    onUnload          = "Local_RscGear_Running = false; ['RscGear_onUnload', _this] call Func_Dialog_HandleGearDialog; if (Local_ShowRespawnDialogOnUnload) then {[] spawn Func_Dialog_CreateRespawnDialog}";
